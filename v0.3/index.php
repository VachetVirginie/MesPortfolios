...
<br>
   ...
   ?> 
                ...
                <div class="righta">
                    <img class="imge" src="image/projet.png" />
                    <img class="imge" src="image/projet2.png" />
                    <img class="imge" src="image/todo.png" />
                    <img class="imge" src="image/jeux.png" />



                    <img class="imge" src="image/jeu2.png" />





                    <img class="imge" src="image/jeu4.png" />
        ...
        <article id="articledeux">
            <div id="skills_ap" class="full showed">
                <div class="centrado">
                        ...
                        <br>
                        <img style="width:61px; margin-left:-11px; " class="imgs" src="image/html.png" />HTML<br>
                        <img style="width:50px;"class="imgs" src="image/css.png" />CSS<br>
                        <img style="width:50px;"class="imgs" src="image/js.png" />Javascript<br>
                        <br>
                    </div>
                        ...
                        <br>
                        <img style="width:50px;"class="imgs" src="image/php.png" />Php<br>
                        <br>
